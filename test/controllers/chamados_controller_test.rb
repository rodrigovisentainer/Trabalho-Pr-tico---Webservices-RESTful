...
class ChamadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chamado" do
    assert_difference('Chamado.count') do
      post chamados_url, params: { chamado: { atendente_id: @chamado.atendente_id, descricao: @chamado.descricao, prioridade: @chamado.prioridade, usuario_id: @chamado.usuario_id } }
    end
  ...
  test "should update chamado" do
    patch chamado_url(@chamado), params: { chamado: { atendente_id: @chamado.atendente_id, descricao: @chamado.descricao, prioridade: @chamado.prioridade, usuario_id: @chamado.usuario_id } }
