...
class AtendentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendente" do
    assert_difference('Atendente.count') do
      post atendentes_url, params: { atendente: { nome: @atendente.nome, setor: @atendente.setor } }
    end
  ...
  test "should update atendente" do
    patch atendente_url(@atendente), params: { atendente: { nome: @atendente.nome, setor: @atendente.setor } }
