...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cep: @empresa.cep, cidade: @empresa.cidade, cnpj: @empresa.cnpj, estado: @empresa.estado, nome: @empresa.nome, pais: @empresa.pais, rua: @empresa.rua } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cep: @empresa.cep, cidade: @empresa.cidade, cnpj: @empresa.cnpj, estado: @empresa.estado, nome: @empresa.nome, pais: @empresa.pais, rua: @empresa.rua } }
